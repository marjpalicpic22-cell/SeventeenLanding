    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20 pb-16">
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {/* Article Content */}
          <div className="prose prose-sm dark:prose-invert max-w-none space-y-6 text-foreground" data-testid="blog-content">
            {/* Hook */}
            ...
            <section>
              ...
              <p>Because it's not just stuff. It's:</p>
              ...
              <p className="mt-4">So the piles stay. And every pile quietly drains your energy.</p>
            </section>

            {/* Section 2 */}
            <section>
              <h2 className="text-2xl font-bold text-foreground mt-10 mb-4">What Decluttering Actually Gives You</h2>
              <p>Most parents think decluttering is about a tidy house. It's not. It's about capacity.</p>
              <p>When you declutter, you get:</p>
              <ul className="space-y-2 ml-4 text-muted-foreground">
                <li className="flex items-start gap-3">
                  <span className="text-primary font-bold">•</span>
            ...
            <section>
              ...
              <p>The reason decluttering works with a marketplace is simple.</p>
              <p>You stop thinking: <em>I'm getting rid of this.</em></p>
              <p>And start thinking: <em>Another family will actually use this.</em></p>
              <p>That shift makes it easier to let go.</p>
            </section>
            ...
            <section>
              ...
              <ol className="space-y-2 ml-4 text-muted-foreground list-decimal">
                ...
                <li>Pick one category: books, dress ups, toy bins, clothes</li>
                <li>Pull out anything your kid has outgrown or ignored for 30 days</li>
                <li>Make 3 piles: keep, list, donate</li>
                <li>List only three items to start</li>
              </ol>
              <p className="mt-4 text-foreground font-medium">That's it.</p>
              <p>Momentum is the goal, not perfection.</p>
            </section>
            ...
            <section>
              ...
              <p className="mt-4">You declutter and save money on kids costs at the same time.</p>
            </section>

            {/* Section 6 */}
            <section>
              <h2 className="text-2xl font-bold text-foreground mt-10 mb-4">What to List First for Fast Wins</h2>
              <p>Start with the things parents search constantly:</p>
              <ul className="space-y-2 ml-4 text-muted-foreground">
                <li className="flex items-start gap-3">
                  <span className="text-primary font-bold">•</span>
